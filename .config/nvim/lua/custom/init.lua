...
vim.api.nvim_set_keymap('n', 'ª', ':m .-2<CR>==', {
    noremap = true,
    silent = true
})
...
vim.api.nvim_set_keymap('v', 'ª', ":m '>-2<CR>gv=gv", {
    noremap = true,
    silent = true
})

vim.api.nvim_set_keymap('n', 'ﬁ', ':lua insert_task_list_item()<CR>', {
    noremap = true,
    silent = true
})
vim.api.nvim_set_keymap('i', 'ﬁ', '<Esc>:lua insert_task_list_item()<CR>a', {
    noremap = true,
    silent = true
})
